    ...
    return (
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-0 bg-[#EDEEF0] rounded-full sm:rounded-full rounded">
            <input
                ...
                className="flex-1 px-4 sm:px-7 py-3 sm:py- text-lg bg-[#EDEEF0] rounded-full sm:rounded-full rounded focus:outline-none focus:ring-2 focus:ring-[#FF6B5B] placeholder-gray-400 text-sm sm:text-base" />
            <button
